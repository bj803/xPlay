      ...
      <div className='grow flex flex-col justify-center space-y-6'>
        <div>
          <div className='flex items-center justify-between'>
                      <TypographyH1 className='text-base sm:text-lg lg:text-lg'>WebClipShare</TypographyH1>
            <ThemeToggle />
          </div>
        ...
        <div className='text-center text-xs text-muted-foreground/70'><p>Powered By Benny</p></div>
      </div>
    </main>
  );
}
