...
export async function GET(request: Request) {
  ...
  const splitChapters = searchParams.get('splitChapters') === 'true';
  const concurrentFragments = parseInt(searchParams.get('concurrentFragments') || '1', 10) || 1;
  ...
  const sponsorBlockCategories = searchParams.get('sponsorBlockCategories') || '';
